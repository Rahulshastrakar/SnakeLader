...
public class Player {
    ...
    private String name;
    private static Board gamewBoard= new Board();
    ...
    public void movePlayer(int diceValue){
        if(currentPosition+diceValue<=100) {
            ...
            int newPosition= gamewBoard.getNewPosition(currentPosition);
...
//        int x= gamewBoard.getXCoordinate(currentPosition);
//        int y= gamewBoard.getYCoordinate(currentPosition);
...
//        coin.setTranslateY(y);
    ...
    private TranslateTransition translateAnimation(int diceValue){
        ...
        animate.setToX(gamewBoard.getXCoordinate(currentPosition));
        animate.setToY(gamewBoard.getYCoordinate(currentPosition));
